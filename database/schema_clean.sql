...
-- Started on 2021-12-16 03:35:05 CST
...
SELECT pg_catalog.setval('base_schema.ingredient_list_macro_ingredient_id_seq', 1, true);
...
SELECT pg_catalog.setval('base_schema.users_user_id_seq', 1, true);
...
-- Completed on 2021-12-16 03:35:05 CST
